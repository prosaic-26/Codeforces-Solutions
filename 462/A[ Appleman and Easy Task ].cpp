head>
    ...
    <meta name="X-Csrf-Token" content="10cebb1a80734397365b03dd4becb886"/>
    ...
    <meta property="og:title" content="Submission #47100525 - Codeforces"/>
    ...
    <meta name="cc" content="2b63ab849d8716faa3def4c63a6b3256a3c5746c"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #47100525 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='10cebb1a80734397365b03dd4becb886'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F462%2Fsubmission%2F47100525">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='10cebb1a80734397365b03dd4becb886'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/462">Problems</a></li>
        <li><a
                                        href="/contest/462/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/462/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/462/status">Status</a></li>
        <li><a
                                        href="/contest/462/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/462/room/1">Room</a></li>
        <li><a
                                        href="/contest/462/standings">Standings</a></li>
        <li><a
                                        href="/contest/462/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Appleman and Easy Task" href="/contest/462/problem/A">462A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-47100525" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
    ...
    for(int i=1;i<=n;i++){
        for(int j=1;j<=n;j++){
            if(a[i-1][j]==&#39;o&#39;&&a[i+1][j]==&#39;o&#39;&&a[i][j+1]==&#39;o&#39;&&a[i][j-1]==&#39;o&#39;)
             continue;
             else if((a[i+1][j]==&#39;o&#39;&&a[i-1][j]==&#39;o&#39;)||(a[i+1][j]==&#39;o&#39;&&a[i][j-1]==&#39;o&#39;)||(a[i+1][j]==&#39;o&#39;&&a[i][j+1]==&#39;o&#39;)||(a[i-1][j]==&#39;o&#39;&&a[i][j-1]==&#39;o&#39;)||(a[i-1][j]==&#39;o&#39;&&a[i][j+1]==&#39;o&#39;)|(a[i][j-1]==&#39;o&#39;&&a[i][j+1]==&#39;o&#39;))
             continue;
             else if(a[i-1][j]==&#39;x&#39;&&a[i+1][j]==&#39;x&#39;&&a[i][j+1]==&#39;x&#39;&&a[i][j-1]==&#39;x&#39;)
             continue;
             else{
                 cout<<"NO";
                 return 0;
