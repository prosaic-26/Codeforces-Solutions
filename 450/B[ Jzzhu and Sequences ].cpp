head>
    ...
    <meta name="X-Csrf-Token" content="81d4eef5b2d8131a23a06e68ae04f52f"/>
    ...
    <meta property="og:title" content="Submission #54472116 - Codeforces"/>
    ...
    <meta name="cc" content="817bb7dd16c0839b2f2483d184b068d88ce09509"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54472116 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='81d4eef5b2d8131a23a06e68ae04f52f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F450%2Fsubmission%2F54472116">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='81d4eef5b2d8131a23a06e68ae04f52f'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/450">Problems</a></li>
        <li><a
                                        href="/contest/450/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/450/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/450/status">Status</a></li>
        <li><a
                                        href="/contest/450/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/450/room/1">Room</a></li>
        <li><a
                                        href="/contest/450/standings">Standings</a></li>
        <li><a
                                        href="/contest/450/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - Jzzhu and Sequences" href="/contest/450/problem/B">450B</a>
         - <span title="problem revision">62</span>
    </td>
    <td>
    GNU C++14
    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54472116" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
    ...
    <pre id="program-source-text" class="prettyprint lang-cpp linenums program-source" style="padding: 0.5em;">#include <iostream>
using namespace std;
...
int32_t main()
{
 ...
 n=n%6;
 if(n<0) n+=6;
 if(n==0) cout<<(x-y+2*mod)%mod;
 else if(n==1) cout<<(x+2*mod)%mod;
 else if(n==2) cout<<(y+2*mod)%mod;
 else if(n==3) cout<<(y-x+2*mod)%mod;
 else if(n==4) cout<<(-x+2*mod)%mod;
 else if(n==5) cout<<(-y+2*mod)%mod;
return 0;
