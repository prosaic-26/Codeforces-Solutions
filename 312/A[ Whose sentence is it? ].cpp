head>
    ...
    <meta name="X-Csrf-Token" content="89e1c68b761f866f892c274fce9374ac"/>
    ...
    <meta property="og:title" content="Submission #42908320 - Codeforces"/>
    ...
    <meta name="cc" content="77535313fb18a03af77a30092160c7cd2e42652e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #42908320 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='89e1c68b761f866f892c274fce9374ac'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F312%2Fsubmission%2F42908320">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='89e1c68b761f866f892c274fce9374ac'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/312">Problems</a></li>
        <li><a
                                        href="/contest/312/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/312/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/312/status">Status</a></li>
        <li><a
                                        href="/contest/312/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/312/room/1">Room</a></li>
        <li><a
                                        href="/contest/312/standings">Standings</a></li>
        <li><a
                                        href="/contest/312/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Whose sentence is it?" href="/contest/312/problem/A">312A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-42908320" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    int n,c1=0;
    cin>>n;
    string s1="miao.",s2="lala.";
    string s;
    for(int i=0;i<=n;i++){
    	getline(cin,s);
    	c1=s.length()-5;
    	if(i==0) continue;
    if(s.length()<5) cout<<"OMG>.< I don&#39;t know!"<<endl;
    else if(s.substr(0,5)==s1&&s.substr(c1,5)==s2) cout<<"OMG>.< I don&#39;t know!"<<endl;
    else if(s.substr(0,5)==s1) cout<<"Rainbow&#39;s"<<endl;
    else if(s.substr(c1,5)==s2) cout<<"Freda&#39;s"<<endl;
