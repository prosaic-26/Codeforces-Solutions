head>
    ...
    <meta name="X-Csrf-Token" content="50ef6f80b475dba4a5b5997e278d5d47"/>
    ...
    <meta property="og:title" content="Submission #56029546 - Codeforces"/>
    ...
    <meta name="cc" content="001d32851c32bffa0c73f1c95ad8f8ab9e10db7d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #56029546 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='50ef6f80b475dba4a5b5997e278d5d47'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F356%2Fsubmission%2F56029546">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='50ef6f80b475dba4a5b5997e278d5d47'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/356">Problems</a></li>
        <li><a
                                        href="/contest/356/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/356/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/356/status">Status</a></li>
        <li><a
                                        href="/contest/356/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/356/room/1">Room</a></li>
        <li><a
                                        href="/contest/356/standings">Standings</a></li>
        <li><a
                                        href="/contest/356/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Knight Tournament" href="/contest/356/problem/A">356A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-56029546" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int vis[1400000];
int k=0;
void buildtr(int ss,int se,int ind){
    if(ss==se){
        tree[ind]=0;
        return;
    }
    int mid=(ss+se)/2;
    buildtr(ss,mid,2*ind);
    buildtr(mid+1,se,2*ind+1);
    tree[ind]=0;
}
void updatetr(int ss,int se,int qs,int qe,int w,int ind){
    if(qe<ss||qs>se||vis[ind]){
        return ;
    }
    if(se<=qe&&qs<=ss){
        tree[ind]=w;
    ...
    int mid=(ss+se)/2;
    updatetr(ss,mid,qs,qe,w,2*ind);
    updatetr(mid+1,se,qs,qe,w,2*ind+1);
}
void ansit(int ss,int se,int ind,int p){
    if(!vis[ind]) tree[ind]=p;
    else p=tree[ind];
    if(ss==se){
        if(ss==tree[ind]) 
            cout<<0<<" ";
    ...
    int mid=(ss+se)/2;
    ansit(ss,mid,2*ind,p);
    ansit(mid+1,se,2*ind+1,p);
}
int32_t main(){
    IOS
    ...
    while(m--){
        ...
        x--,y--,z--;
        if(z-1>=x)
        updatetr(0,n-1,x,z-1,z,1);
        if(y>=z+1)
        updatetr(0,n-1,z+1,y,z,1);
        // cout<<0;
    }
    ansit(0,n-1,1,-1);
}