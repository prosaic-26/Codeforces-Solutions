head>
    ...
    <meta name="X-Csrf-Token" content="e3b7d8f5a90f47842b3c9b2a7dd63e9c"/>
    ...
    <meta property="og:title" content="Submission #47307192 - Codeforces"/>
    ...
    <meta name="cc" content="88b9182e1b63cc99aed8ce0e11aeede8ea292834"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #47307192 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e3b7d8f5a90f47842b3c9b2a7dd63e9c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F131%2Fsubmission%2F47307192">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e3b7d8f5a90f47842b3c9b2a7dd63e9c'/>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-47307192" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main(){
    ...
    else if((int)s[0]>96&&c==s.length()-1)
    {
        cout<<(char)(s[0]-32);
