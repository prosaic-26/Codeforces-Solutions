head>
    ...
    <meta name="X-Csrf-Token" content="b38a3bf8cd3be795287bcc0677e8a4a6"/>
    ...
    <meta property="og:title" content="Submission #47399354 - Codeforces"/>
    ...
    <meta name="cc" content="21dfdf7c8a884bf5908a07aa506ab4d6d549b28f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #47399354 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b38a3bf8cd3be795287bcc0677e8a4a6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F353%2Fsubmission%2F47399354">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b38a3bf8cd3be795287bcc0677e8a4a6'/>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-47399354" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main(){
    ...
    forn(i,0,n){
        ...
        sux+=x[i];
        suy+=y[i];
        if((x[i]&1&&!(y[i]&1))||(y[i]&1&&!(x[i]&1)))
         c++;
    }
    if(sux%2==0&&suy%2==0) cout<<0;
    else if(sux%2!=0&&suy%2!=0&&c>0) cout<<1;
    else cout<<-1;
}