head>
    ...
    <meta name="X-Csrf-Token" content="bff457023bbc32e059bfef9fe0e678cf"/>
    ...
    <meta property="og:title" content="Submission #55860197 - Codeforces"/>
    ...
    <meta name="cc" content="2c43a6af4373139af565b95b4aee4bece5163747"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #55860197 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bff457023bbc32e059bfef9fe0e678cf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F598%2Fsubmission%2F55860197">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bff457023bbc32e059bfef9fe0e678cf'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/598">Problems</a></li>
        <li><a
                                        href="/contest/598/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/598/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/598/status">Status</a></li>
        <li><a
                                        href="/contest/598/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/598/standings">Standings</a></li>
        <li><a
                                        href="/contest/598/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="D - Igor In the Museum" href="/contest/598/problem/D">598D</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55860197" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void dfs(int u,int v){
    vis[u][v]=b;
    if(u<n-1&&a[u+1][v]==a[u][v]){
        if(!vis[u+1][v]){
            dfs(u+1,v);
        }
    }
    else if(u<n-1&&a[u+1][v]!=a[u][v]) p++;
    if(u>0&&a[u-1][v]==a[u][v]){
        if(!vis[u-1][v]){
            dfs(u-1,v);
        }
    }
    else if(u>0&&a[u-1][v]!=a[u][v]) p++;
    if(v>0&&a[u][v-1]==a[u][v]){
        if(!vis[u][v-1]){
            dfs(u,v-1);
        }
    }
    else if(v>0&&a[u][v-1]!=a[u][v]) p++;
    if(v<m-1&&a[u][v+1]==a[u][v]){
        if(!vis[u][v+1]){
            dfs(u,v+1);
        }
    }
    else if(v<m-1&&a[u][v+1]!=a[u][v]) p++;
}
int par[1000001];
int32_t main(){
    IOS
