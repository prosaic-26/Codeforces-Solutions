head>
    ...
    <meta name="X-Csrf-Token" content="acbc017492ed72e77b23e8a161f9ee3e"/>
    ...
    <meta property="og:title" content="Submission #55675861 - Codeforces"/>
    ...
    <title>Submission #55675861 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='acbc017492ed72e77b23e8a161f9ee3e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F165%2Fsubmission%2F55675861">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='acbc017492ed72e77b23e8a161f9ee3e'/>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="C - Another Problem on Strings" href="/contest/165/problem/C">165C</a>
         - <span title="problem revision">13</span>
    </td>
    <td>
    GNU C++14
    </td>
    ...
    <td>2019-06-17 13:22:57</td>
    <td>2019-06-17 13:22:58</td>
    <td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55675861" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main(){
    ...
    for (int i = 0; i < n+1; ++i)
    {
        ...
        if(k1==k+1){
            if(k==0)
                ans+=(a[c-1]-a[c-2]-1)*(a[c-1]-a[c-2])/2;
            else
            ans+=a[c-1]-a[c-2]-1+a[c-k-1]-a[c-k-2]-1+1+(a[c-1]-a[c-2]-1)*(a[c-k-1]-a[c-k-2]-1);
            k1--;
        }
    }
    cout<<ans;
