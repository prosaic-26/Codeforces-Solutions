head>
    ...
    <meta name="X-Csrf-Token" content="dfeb152cc3d4c155b5a59f62db474b90"/>
    ...
    <meta property="og:title" content="Submission #41403259 - Codeforces"/>
    ...
    <meta name="cc" content="8117f57cde2750e366f83e3430956a28b663b572"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #41403259 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='dfeb152cc3d4c155b5a59f62db474b90'>&nbsp;</span>
...
<a href="//codeforces.com/vkcup2012"><img src="http://stat.codeforces.ru/images/vkcup2012-2.png"/>
</a>
</div>
    </div>
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F158%2Fsubmission%2F41403259">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dfeb152cc3d4c155b5a59f62db474b90'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/158">Problems</a></li>
        <li><a
                                        href="/contest/158/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/158/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/158/status">Status</a></li>
        <li><a
                                        href="/contest/158/standings">Standings</a></li>
        <li><a
                                        href="/contest/158/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Next Round" href="/contest/158/problem/A">158A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-41403259" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main() {
	...
	if(a[k-1]!=0){
		cs=k;
		for(int j=0;a[k-1]==a[k+j];j++)
		cs++;
	}
	else
	 {
	 	for(int j=k-2;j>=0;j--)
	 	if(a[j]!=0) {cs=j+1; break;}
	 }
	cout<<cs;
	return 0;
}