head>
    ...
    <meta name="X-Csrf-Token" content="79ad3576a367205b47dffbd65dc8ea88"/>
    ...
    <meta property="og:title" content="Submission #55327684 - Codeforces"/>
    ...
    <meta name="cc" content="05012c475b43d9c912b6a80088b2a394c88f56c0"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #55327684 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='79ad3576a367205b47dffbd65dc8ea88'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F466%2Fsubmission%2F55327684">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='79ad3576a367205b47dffbd65dc8ea88'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/466">Problems</a></li>
        <li><a
                                        href="/contest/466/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/466/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/466/status">Status</a></li>
        <li><a
                                        href="/contest/466/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/466/room/1">Room</a></li>
        <li><a
                                        href="/contest/466/standings">Standings</a></li>
        <li><a
                                        href="/contest/466/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - Wonder Room" href="/contest/466/problem/B">466B</a>
         - <span title="problem revision">42</span>
    </td>
    <td>
    GNU C++14
    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55327684" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
std::vector<vector<int>> adj(200005);
int c[200005];
int vis[200005];
set<int> s;
int f=0,f2,k;
...
int32_t main(){
    ...
    b=b1;
    n*=6;
    if(ceil((double)n/b)<=a){
        cout<<a*b<<endl;
        cout<<a<<" "<<b;
        return 0;
    }
    int mi=1000000000000000;
    for (int i = a; i*i<=n ; ++i)
    {
        // cout<<ceil((double)n/i)<<endl;
        if(ceil((double)n/i)>=b){
            // cout<<ceil((double)n/a)<<endl;
            if(i*ceil((double)n/i)<mi){
                b1=ceil((double)n/i);
                a1=i;
                mi=min(mi,i*b1);
            }
