head>
    ...
    <meta name="X-Csrf-Token" content="cf04dd58da1feff0a5675256783687e2"/>
    ...
    <meta property="og:title" content="Submission #44460549 - Codeforces"/>
    ...
    <meta name="cc" content="4f9fd4f09a19d67fc0d17b912afa13c6dfe2efdd"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #44460549 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cf04dd58da1feff0a5675256783687e2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F459%2Fsubmission%2F44460549">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cf04dd58da1feff0a5675256783687e2'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/459">Problems</a></li>
        <li><a
                                        href="/contest/459/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/459/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/459/status">Status</a></li>
        <li><a
                                        href="/contest/459/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/459/room/1">Room</a></li>
        <li><a
                                        href="/contest/459/standings">Standings</a></li>
        <li><a
                                        href="/contest/459/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Pashmak and Garden" href="/contest/459/problem/A">459A</a>
         - <span title="problem revision">61</span>
    </td>
    <td>
    GNU C++14
    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-44460549" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main() {
    ...
    else if(x==0&&y>0) cout<<x1+y<<" "<<y1<<" "<<x2+y<<" "<<y2;
    else if(x==0&&y<0)  cout<<x1-y<<" "<<y1<<" "<<x2-y<<" "<<y2;
    else if(x<0&&y==0) cout<<x1<<" "<<y1-x<<" "<<x2<<" "<<y2-x;
    else if(x>0&&y==0) cout<<x1<<" "<<y1+x<<" "<<x2<<" "<<y2+x;
    else cout<<-1;
	return 0;
}
