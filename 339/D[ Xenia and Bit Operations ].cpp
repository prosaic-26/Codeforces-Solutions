head>
    ...
    <meta name="X-Csrf-Token" content="51b8fb66f8495758fb29e7d1472b3c06"/>
    ...
    <meta property="og:title" content="Submission #56024188 - Codeforces"/>
    ...
    <meta name="cc" content="337a66bdef851fe79082fb611cdbe4ec11ceaaa1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #56024188 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='51b8fb66f8495758fb29e7d1472b3c06'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F339%2Fsubmission%2F56024188">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='51b8fb66f8495758fb29e7d1472b3c06'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/339">Problems</a></li>
        <li><a
                                        href="/contest/339/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/339/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/339/status">Status</a></li>
        <li><a
                                        href="/contest/339/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/339/room/1">Room</a></li>
        <li><a
                                        href="/contest/339/standings">Standings</a></li>
        <li><a
                                        href="/contest/339/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="D - Xenia and Bit Operations" href="/contest/339/problem/D">339D</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-56024188" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
void updatetr(int ss,int se,int x,int y,int ind){
    if(x<ss||x>se){
        return ;
    }
    if(ss==se){
    ...
    int mid=(ss+se)/2;
    updatetr(ss,mid,x,y,2*ind);
    updatetr(mid+1,se,x,y,2*ind+1);
    if(k==1){
        tree[ind]=tree[2*ind]|tree[2*ind+1];
        k=0;
    }
