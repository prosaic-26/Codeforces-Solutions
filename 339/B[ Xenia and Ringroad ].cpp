head>
    ...
    <meta name="X-Csrf-Token" content="bf3b423b77822cbb853f1f937b91d017"/>
    ...
    <meta property="og:title" content="Submission #41672141 - Codeforces"/>
    ...
    <title>Submission #41672141 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bf3b423b77822cbb853f1f937b91d017'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F339%2Fsubmission%2F41672141">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bf3b423b77822cbb853f1f937b91d017'/>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - Xenia and Ringroad" href="/contest/339/problem/B">339B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-41672141" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    while(j<m){
    	if(j==0){ t=a[j]-1; j++;}
    	else if(a[j]>=a[j-1]) {t+=a[j]-a[j-1]; j++;}
    	else {t=t+n-a[j-1]+a[j]; j++;}
    }
    cout<<t;
	return 0;
}