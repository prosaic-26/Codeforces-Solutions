head>
    ...
    <meta name="X-Csrf-Token" content="3a3f1c19cf5d335ff5a6ef8190013fea"/>
    ...
    <meta property="og:title" content="Submission #48790517 - Codeforces"/>
    ...
    <meta name="cc" content="fce491673e59ae88127e88eff157135f56a664cd"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #48790517 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3a3f1c19cf5d335ff5a6ef8190013fea'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F271%2Fsubmission%2F48790517">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3a3f1c19cf5d335ff5a6ef8190013fea'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/271">Problems</a></li>
        <li><a
                                        href="/contest/271/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/271/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/271/status">Status</a></li>
        <li><a
                                        href="/contest/271/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/271/room/1">Room</a></li>
        <li><a
                                        href="/contest/271/standings">Standings</a></li>
        <li><a
                                        href="/contest/271/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - Prime Matrix" href="/contest/271/problem/B">271B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-48790517" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
{
    IOS
    vector<char> prime (100003+1, true);
    ...
    for (int i = 0; i < n; ++i)
    {
        ...
        {
            /* code */
            c[j]+=isprime[a[i][j]]-a[i][j];
            r[i]+=isprime[a[i][j]]-a[i][j];
        }
        if(r[i]<min) min=r[i];
    }
    // cout<<c[1];
