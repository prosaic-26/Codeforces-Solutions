head>
    ...
    <meta name="X-Csrf-Token" content="3dbe313703ff63be9645d03a4e65cbbf"/>
    ...
    <meta property="og:title" content="Submission #44446965 - Codeforces"/>
    ...
    <meta name="cc" content="6a0bd729381b5d2491ae2ab3fad61a9bfe957870"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #44446965 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3dbe313703ff63be9645d03a4e65cbbf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F208%2Fsubmission%2F44446965">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3dbe313703ff63be9645d03a4e65cbbf'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/208">Problems</a></li>
        <li><a
                                        href="/contest/208/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/208/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/208/status">Status</a></li>
        <li><a
                                        href="/contest/208/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/208/room/1">Room</a></li>
        <li><a
                                        href="/contest/208/standings">Standings</a></li>
        <li><a
                                        href="/contest/208/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Dubstep" href="/contest/208/problem/A">208A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-44446965" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main() {
    ...
    else if(s[s.length()-4]==&#39;W&#39;&&s[s.length()-3]==&#39;U&#39;&&s[s.length()-2]==&#39;B&#39;) cout<<s[s.length()-1];
    else cout<<s[s.length()-2]<<s[s.length()-1];
}
