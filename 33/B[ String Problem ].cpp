head>
    ...
    <meta name="X-Csrf-Token" content="8601fb0f60b2f3a559b49fab7ea5622f"/>
    ...
    <meta property="og:title" content="Submission #55710052 - Codeforces"/>
    ...
    <meta name="cc" content="d01d4fd5feac6eb6c6fa954cc31f2fba5384fb8d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #55710052 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8601fb0f60b2f3a559b49fab7ea5622f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F33%2Fsubmission%2F55710052">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8601fb0f60b2f3a559b49fab7ea5622f'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/33">Problems</a></li>
        <li><a
                                        href="/contest/33/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/33/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/33/status">Status</a></li>
        <li><a
                                        href="/contest/33/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/33/room/1">Room</a></li>
        <li><a
                                        href="/contest/33/standings">Standings</a></li>
        <li><a
                                        href="/contest/33/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - String Problem" href="/contest/33/problem/B">33B</a>
         - <span title="problem revision">20</span>
    </td>
    <td>
    GNU C++14
    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-55710052" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main(){
    ...
    for (int i = 0; i < s1.length(); ++i)
    {
        ...
        for (int j = 0; j < 26; ++j)
        {
            if(a[(int)s1[i]-&#39;a&#39;][j]+a[(int)s2[i]-&#39;a&#39;][j]<mi){
                mi=a[(int)s1[i]-&#39;a&#39;][j]+a[(int)s2[i]-&#39;a&#39;][j];
                ind=j;
            }
        }
        if(ind==-1)
