head>
    ...
    <meta name="X-Csrf-Token" content="c1dd96075395784de3c37bb8055ebfa0"/>
    ...
    <meta property="og:title" content="Submission #42907070 - Codeforces"/>
    ...
    <meta name="cc" content="05173d14bac861720f6c77b2ce38373172ccfa48"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #42907070 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c1dd96075395784de3c37bb8055ebfa0'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F540%2Fsubmission%2F42907070">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c1dd96075395784de3c37bb8055ebfa0'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/540">Problems</a></li>
        <li><a
                                        href="/contest/540/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/540/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/540/status">Status</a></li>
        <li><a
                                        href="/contest/540/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/540/room/1">Room</a></li>
        <li><a
                                        href="/contest/540/standings">Standings</a></li>
        <li><a
                                        href="/contest/540/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Combination Lock" href="/contest/540/problem/A">540A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-42907070" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    for(long long i=0;i<n;i++){
    	if(s1[i]>s2[i]){
    	if(s2[i]-&#39;0&#39;+&#39;9&#39;-s1[i]+1<s1[i]-s2[i])
    	 cs+=s2[i]-&#39;0&#39;+&#39;9&#39;-s1[i]+1;
    	 else cs+=s1[i]-s2[i];}
    	 
    	 else{
    	 if(s1[i]-&#39;0&#39;+&#39;9&#39;-s2[i]+1<s2[i]-s1[i])
    	 cs+=s1[i]-&#39;0&#39;+&#39;9&#39;-s2[i]+1;
    	 else cs+=s2[i]-s1[i];}
