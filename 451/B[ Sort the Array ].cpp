head>
    ...
    <meta name="X-Csrf-Token" content="3a6bf4b850f7c49fc40885ca7adb971e"/>
    ...
    <meta property="og:title" content="Submission #48446568 - Codeforces"/>
    ...
    <title>Submission #48446568 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3a6bf4b850f7c49fc40885ca7adb971e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F451%2Fsubmission%2F48446568">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3a6bf4b850f7c49fc40885ca7adb971e'/>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - Sort the Array" href="/contest/451/problem/B">451B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-48446568" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int main()
{
    ...
    f=0;
    if((x<n&&a[in]>a[x])||(in>0&&a[en]<a[in-1])) f=1;
    for(int i=x+1;i<n;i++){
        if(a[i]<a[i-1]){
            f=1;
            break;
