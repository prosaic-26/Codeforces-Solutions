head>
    ...
    <meta name="X-Csrf-Token" content="53af7a659f610c1b003b9a233e48612a"/>
    ...
    <meta property="og:title" content="Submission #54489069 - Codeforces"/>
    ...
    <meta name="cc" content="f4fabd499cf494d62e46a076d3787beb9e988d6d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #54489069 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='53af7a659f610c1b003b9a233e48612a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F455%2Fsubmission%2F54489069">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='53af7a659f610c1b003b9a233e48612a'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/455">Problems</a></li>
        <li><a
                                        href="/contest/455/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/455/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/455/status">Status</a></li>
        <li><a
                                        href="/contest/455/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/455/room/1">Room</a></li>
        <li><a
                                        href="/contest/455/standings">Standings</a></li>
        <li><a
                                        href="/contest/455/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Boredom" href="/contest/455/problem/A">455A</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-54489069" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int dpt(int i){
    ...
    if(dp[i]!=-1)
     return dp[i];
    dp[i]=max(dpt(i-1),dpt(i-2)+i*c[i]);
    return dp[i];
}
int32_t main(){
    IOS
