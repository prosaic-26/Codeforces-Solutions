head>
    ...
    <meta name="X-Csrf-Token" content="2b15b9497eda33fa9f4656b88c1b7943"/>
    ...
    <meta property="og:title" content="Submission #44681171 - Codeforces"/>
    ...
    <meta name="cc" content="a8b7ecf037b4c7a24b11f398f3cb27ad3ea954c8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #44681171 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2b15b9497eda33fa9f4656b88c1b7943'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F205%2Fsubmission%2F44681171">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2b15b9497eda33fa9f4656b88c1b7943'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/205">Problems</a></li>
        <li><a
                                        href="/contest/205/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/205/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/205/status">Status</a></li>
        <li><a
                                        href="/contest/205/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/205/room/1">Room</a></li>
        <li><a
                                        href="/contest/205/standings">Standings</a></li>
        <li><a
                                        href="/contest/205/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="A - Little Elephant and Rozdil" href="/contest/205/problem/A">205A</a>
         - <span title="problem revision">38</span>
    </td>
    <td>
    GNU C++14
    </td>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-44681171" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main()
{
    ...
    for(int i=1;i<n;i++){
        cin>>a[i];
        if(a[i]<min){ min=a[i]; j=i+1;}
    }
    for(int i=0;i<n;i++){
        if(i!=j-1&&min==a[i])
         f=1;
    }
    if(f==1) cout<<"Still Rozdil";
    else cout<<j;
    return 0;
