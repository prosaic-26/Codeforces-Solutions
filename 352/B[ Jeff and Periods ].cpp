head>
    ...
    <meta name="X-Csrf-Token" content="f85ffd19d35e87ff527bc74de7853b78"/>
    ...
    <meta property="og:title" content="Submission #47318712 - Codeforces"/>
    ...
    <meta name="cc" content="ac139702fa5018a2f7cef2cd13ad5c0e358d3659"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #47318712 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f85ffd19d35e87ff527bc74de7853b78'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F352%2Fsubmission%2F47318712">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f85ffd19d35e87ff527bc74de7853b78'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/352">Problems</a></li>
        <li><a
                                        href="/contest/352/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/352/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/352/status">Status</a></li>
        <li><a
                                        href="/contest/352/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/352/room/1">Room</a></li>
        <li><a
                                        href="/contest/352/standings">Standings</a></li>
        <li><a
                                        href="/contest/352/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="B - Jeff and Periods" href="/contest/352/problem/B">352B</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-47318712" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int32_t main(){
    ...
    for(int i=1;i<=n;i++){
        ...
        else if(d[a[i]]!=-1&&c[a[i]]>2&&i-k[a[i]]!=d[a[i]]){
            d[a[i]]=-1;
            l--;
          //  cout<<1;
        }
