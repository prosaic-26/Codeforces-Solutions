head>
    ...
    <meta name="X-Csrf-Token" content="58744c265dfaa170c331b225f1f1b82e"/>
    ...
    <meta property="og:title" content="Submission #58986821 - Codeforces"/>
    ...
    <meta name="cc" content="a733be8438b69a639f4da28d36fec2ef48a67032"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #58986821 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='58744c265dfaa170c331b225f1f1b82e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F276%2Fsubmission%2F58986821">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='58744c265dfaa170c331b225f1f1b82e'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/276">Problems</a></li>
        <li><a
                                        href="/contest/276/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/276/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/276/status">Status</a></li>
        <li><a
                                        href="/contest/276/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/276/room/1">Room</a></li>
        <li><a
                                        href="/contest/276/standings">Standings</a></li>
        <li><a
                                        href="/contest/276/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/Prosaic_26" title="Specialist Prosaic_26" class="rated-user user-cyan">Prosaic_26</a>    </td>
    <td>
        <a title="C - Little Girl and Maximum Sum" href="/contest/276/problem/C">276C</a>
    ...
    <div class="roundbox SubmissionDetailsFrameRoundBox-58986821" style="margin-top:2em;font-size:1.1rem;">
            <div class="roundbox-lt">&nbsp;</div>
            <div class="roundbox-rt">&nbsp;</div>
...
int dpl(int n){
    ...
    int ans=0;
    if(n>0) ans+=1+dpl(n-1);
    if(n>k-1) ans+=1+dpl(n-k);
    ans%=mod;
    return dp[n]=ans;
}
int32_t main(){
